...
{
    public class MultipleInputs7Converter : MultipleInputsConverter<MultiplesInputsConvert7EventArgs>
    {
        ...
        {
            MultiplesInputsConvert7EventArgs args = new MultiplesInputsConvert7EventArgs(changedIndex, oldValue)
            {
                Input0 = Input0,
                Input1 = Input1,
                Input2 = Input2,
