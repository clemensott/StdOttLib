...
namespace StdOttStandard
{
    public static class EnumerableUtils
    {
        ...
        public static int IndexOf(this IEnumerable enumerable, object searchItem)
        {
            ...
            {
                if (EqualUtils.ReferenceEqualsOrEquals(item, searchItem)) return i;
        ...
        public static IEnumerable<T> Remove<T>(this IEnumerable<T> items, T item, int max = 1)
        {
            ...
            {
                if (count >= max || EqualUtils.ReferenceEqualsOrEquals(i, item)) return true;
        ...
        {
            return items.Where(i => !EqualUtils.ReferenceEqualsOrEquals(i, item));
        }
