...
{
    public class TaskCompletionSource<TOut, TIn0, TIn1, TIn2, TIn3, TIn4, TIn5, TIn6, TIn7> : TaskCompletionSource<TOut>
    {
        ...
        public TaskCompletionSource(TIn0 input0, TIn1 input1, TIn2 input2, TIn3 input3,
