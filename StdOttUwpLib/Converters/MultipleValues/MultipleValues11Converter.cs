...
{
    public delegate object ConvertInputs11EventHandler(object input0, object input1, object input2, object input3, object input4, object input5, object input6, object input7, object input8, object input9, object input10);
    public delegate object ConvertInputs11RefEventHandler(ref object input0, ref object input1, ref object input2, ref object input3, ref object input4, ref object input5, ref object input6, ref object input7, ref object input8, ref object input9, ref object input10);
    ...
    public class MultipleInputs11Converter : FrameworkElement
    {
        ...
        private void SetOutputRef()
        {
            ...
            object input0 = Input0, input1 = Input1, input2 = Input2, input3 = Input3, input4 = Input4, input5 = Input5, input6 = Input6, input7 = Input7, input8 = Input8, input9 = Input9, input10 = Input10;

            Output = ConvertRef(ref input0, ref input1, ref input2, ref input3, ref input4, ref input5, ref input6, ref input7, ref input8, ref input9, ref input10);
