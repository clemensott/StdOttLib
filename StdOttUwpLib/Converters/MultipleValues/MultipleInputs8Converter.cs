...
{
    public delegate object ConvertInputs8EventHandler(object sender, object input0, object input1, object input2, object input3, object input4, object input5, object input6, object input7, int changedInput, object oldValue);
    public delegate object ConvertInputs8RefEventHandler(object sender, ref object input0, ref object input1, ref object input2, ref object input3, ref object input4, ref object input5, ref object input6, ref object input7, int changedInput, object oldValue);
    ...
    public class MultipleInputs8Converter : FrameworkElement
    {
        ...
        {
            ((MultipleInputs8Converter)sender).SetOutput(0, e.OldValue);
        }
        ...
        {
            ((MultipleInputs8Converter)sender).SetOutput(1, e.OldValue);
        }
        ...
        {
            ((MultipleInputs8Converter)sender).SetOutput(2, e.OldValue);
        }
        ...
        {
            ((MultipleInputs8Converter)sender).SetOutput(3, e.OldValue);
        }
        ...
        {
            ((MultipleInputs8Converter)sender).SetOutput(4, e.OldValue);
        }
        ...
        {
            ((MultipleInputs8Converter)sender).SetOutput(5, e.OldValue);
        }
        ...
        {
            ((MultipleInputs8Converter)sender).SetOutput(6, e.OldValue);
        }
        ...
        {
            ((MultipleInputs8Converter)sender).SetOutput(7, e.OldValue);
        }

        private bool isUpdating;
        private readonly List<ConvertInputs8EventHandler> converts = new List<ConvertInputs8EventHandler>();
        private readonly List<ConvertInputs8RefEventHandler> convertRefs = new List<ConvertInputs8RefEventHandler>();
        ...
        {
            Output = converts.Last()(this, Input0, Input1, Input2, Input3, Input4, Input5, Input6, Input7, changedIndex, oldValue);
        }
        ...
        private void SetOutputRef(int changedIndex, object oldValue)
        {
            ...
            Output = convertRefs.Last()(this, ref input0, ref input1, ref input2, ref input3, ref input4, ref input5, ref input6, ref input7, changedIndex, oldValue);
