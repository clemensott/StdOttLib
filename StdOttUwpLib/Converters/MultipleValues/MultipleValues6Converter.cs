...
{
    public delegate object ConvertInputs6EventHandler(object input0, 
        object input1, object input2, object input3, object input4, object input5);
    public delegate object ConvertInputs6RefEventHandler(ref object input0, ref object input1, 
        ref object input2, ref object input3, ref object input4, ref object input5);
    ...
    public class MultipleInputs6Converter : FrameworkElement
    {
        ...
        private ConvertInputs6EventHandler convert;
        private ConvertInputs6RefEventHandler convertRef;

        public ConvertInputs6EventHandler Convert
        {
            get { return convert; }
            set
            {
        ...
        public ConvertInputs6RefEventHandler ConvertRef
        {
        ...
        {
            Output = Convert(Input0, Input1, Input2, Input3, Input4, Input5);
        }
        ...
        private void SetOutputRef()
        {
            ...
            Output = ConvertRef(ref input0, ref input1, ref input2, ref input3, ref input4, ref input5);
