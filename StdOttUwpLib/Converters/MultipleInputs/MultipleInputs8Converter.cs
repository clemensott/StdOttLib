...
{
    public class MultipleInputs8Converter : MultipleInputsConverter<MultiplesInputsConvert8EventArgs>
    {
        ...
        {
            MultiplesInputsConvert8EventArgs args = new MultiplesInputsConvert8EventArgs(changedIndex, oldValue)
            {
                Input0 = Input0,
                Input1 = Input1,
                Input2 = Input2,
