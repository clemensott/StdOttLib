...
{
    public class MultipleInputs6Converter : MultipleInputsConverter<MultiplesInputsConvert6EventArgs>
    {
        ...
        {
            MultiplesInputsConvert6EventArgs args = new MultiplesInputsConvert6EventArgs(changedIndex, oldValue)
            {
                Input0 = Input0,
                Input1 = Input1,
                Input2 = Input2,
